...
export default function NewResearch() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            const data = await createResearch(accessToken, {
                title,
                slug,
                description,
        ...
        <main className="min-h-screen bg-zinc-100/50 relative pb-20">
            <div className="bg-white px-2 h-12 flex justify-between items-center border-b border-zinc-200">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs tracking-tight text-zinc-500">CREATE RESEARCH</span>
                </div>
            </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    id="title"
                                    type="text"
                                    placeholder="My Untitled Research"
                                    value={title}
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    id="description"
                                    type="text"
                                    placeholder="A short description of your research..."
                                    value={description}
