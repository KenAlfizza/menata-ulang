...
export function ExplorePodcastPlaylist({page} : {page: PageType}) {
    ...
    return (
        <div className="rounded-lg bg-white/80">
            <div className={`rounded-lg ${backgroundColorMap[page]}`}>
                ...
                <div className={`bg-white/20 flex flex-col gap-1 p-2 w-full h-70 overflow-y-auto scrollbar-thin scrollbar-thumb-zinc-500 scrollbar-track-transparent`}>
